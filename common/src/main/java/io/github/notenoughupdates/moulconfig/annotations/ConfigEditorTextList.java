...
public @interface ConfigEditorTextList {
    String disabledSound() default "";

    String enabledSound() default "";

    String defaultSound() default "";

    boolean showColour() default true;

    boolean showNotification() default true;

    boolean showVolume() default true;
}
