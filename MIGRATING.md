...
+ moulconfig = { module = "io.github.akinsoft.softconfig:modern-26.2", version = "4.8.0" }
```

Keep the same artifact name for your Minecraft version. Do not change imports, relocation rules, XML namespaces, assets, or saved configuration files.
