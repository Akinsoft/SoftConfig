...
import io.github.notenoughupdates.moulconfig.internal.StringUtils;
        ...
        for (int yOffI = 0; yOffI < texts.length; yOffI++) {
            ...
            if (isScaling() && Minecraft.getMinecraft().fontRendererObj.getStringWidth(texts[yOffI]) > searchBarXSize - 10) {
                ...
                if ((options & SCISSOR_TEXT) != 0) {
                    ...
                    String toRender = Minecraft.getMinecraft().fontRendererObj.trimStringToWidth(StringUtils.chromaStringByColourCode(
